AutomaticRoomSelection Executable
...
================================
-AutomaticRoomSelection 
-run_AutomaticRoomSelection.sh (shell script for temporarily setting environment 
                                variables and executing the application)
   -to run the shell script, type
   
       ./run_AutomaticRoomSelection.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2025a, run the shell script as:
       ...
       ./run_AutomaticRoomSelection.sh /mathworks/home/application/R2025a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_AutomaticRoomSelection.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2025a/runtime/glnxa64:MR/R2025a/bin/glnxa64:MR/R2025a/sys/os/glnxa64:MR/R2025a/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_AutomaticRoomSelection.sh 
